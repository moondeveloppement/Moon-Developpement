  ...
  return (
    <ul className={moduleMenuUl}>
      ...
      <li className={`${moduleMenuLi} ${moduleMenuLiTarget1}`}>
        <Link to="" className={moduleMenuLink}>Calmer l'Anxiété</Link>
      </li>

      <li className={`${moduleMenuLi} ${moduleMenuLiTarget2}`}>
        <Link to="test" className={moduleMenuLink}>Calmer les Emotions</Link>
      </li>

      <li className={`${moduleMenuLi} ${moduleMenuLiTarget3}`}>
        <Link to="test" className={moduleMenuLink}>Lacher prise</Link>
      </li>

      <li className={`${moduleMenuLi} ${moduleMenuLiTarget4}`}>
        <Link to="test" className={moduleMenuLink}>Contact</Link>
      </li>
    </ul>
  );
}
